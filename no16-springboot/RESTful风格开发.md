...
>REST设计风格，简单地说就是资源定位，每一个资源对应一个网址，既然是资源，那就不应该有非名词存在。
...
## 二、名称
Fielding将他对互联网软件的架构原则，定名为REST，即Representational State Transfer的缩写。我对这个词组的翻译是"表现层状态转化"。如果一个架构符合REST原则，就称它为RESTful架构。要理解RESTful架构，最好的方法就是去理解Representational State Transfer这个词组到底是什么意思，它的每一个词代表了什么涵义。如果你把这个名称搞懂了，也就不难体会REST是一种什么样的设计。
...
使用RESTful风格开发Java Web（示例）：
https://www.cnblogs.com/wmyskxz/p/9104368.html

阮一峰：
https://www.cnblogs.com/niusdtz/p/9715427.html
